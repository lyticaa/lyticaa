...
var (
	...
	baseFiles = []string{
		...
		filepath.Join(cwd, "./internal/web/views/partials/_nav.gohtml"),
		filepath.Join(cwd, "./internal/web/views/partials/_footer.gohtml"),
	}
)
...
func templateList(fileList []string) []string {
	...
	for _, file := range fileList {
		container = append(container, filepath.Join(cwd, "./internal/web/views/"+file+".gohtml"))
	}
